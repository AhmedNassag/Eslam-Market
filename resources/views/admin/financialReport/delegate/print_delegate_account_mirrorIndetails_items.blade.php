...
<body style="padding-top: 10px;font-family: tahoma;">
    <table cellspacing="0" style="width: 30%; margin-right: 5px; float: right;   " dir="rtl">
        ...
        <tr>
            <td style="padding: 5px; text-align: right;font-weight: bold;"> اسم المندوب <span
                    style="margin-right: 10px;">/ {{ $data['name'] }}</span></td>
        </tr>
        <tr>
            <td style="padding: 5px; text-align: right;font-weight: bold;"> رقم التيلفون <span
                    style="margin-right: 10px;">/ {{ $data['phones'] }}</span></td>
        </tr>
        <tr>
            <td style="padding: 5px; text-align: right;font-weight: bold;"> تاريخ الاضافة <span
                    style="margin-right: 10px;">/ {{ $data['date'] }}</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align:left !important;padding: 5px;">
                <img style="width: 150px; height: 110px; border-radius: 10px;"
                    src="{{ asset('admin/uploads') . '/' . $systemData['photo'] }}">
    ...
    <table dir="rtl" border="1" style="width: 98%; margin: 0 auto;" id="example2" cellpadding="1"
        ...
        <tr>
            ...
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                عدد ({{ $data['ServicesForUsCounter'] * 1 }}) فاتورة خدمات قدمها لنا بقيمة
                ({{ $data['ServicesForUsMoney'] * 1 }}) جنيه
            </td>
        </tr>
        <tr>
            <td style="width: 25%; text-align: right; font-weight: bold"> فواتير خدمات قدمناها للمندوب</td>
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                عدد ({{ $data['ServicesForotherCounter'] * 1 }}) فاتورة خدمات قدمناها للمندوب بقيمة
                ({{ $data['ServicesForothermoney'] * 1 }}) جنيه
            </td>
        </tr>
    ...
    <!--  حركة الخدمات-->
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة الخدمات الداخلية والخارجية
        علي حساب للمندوب خلال الفترة</h3>
    @if (@isset($details['services_orders']) &&
        !@empty($details['services_orders']) &&
        count($details['services_orders']) > 0)
    ...
    <!--  حركة النقدية-->
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة النقدية علي حساب العميل
        خلال الفترة</h3>
    @if (@isset($details['Treasuries_transactions']) &&
        !@empty($details['Treasuries_transactions']) &&
        count($details['Treasuries_transactions']) > 0)
        <table dir="rtl" id="example2" class="table table-bordered table-hover"
            style="width: 99%;margin: 0 auto;">
            <thead style="background-color: lightgrey !important">
                <th>رقم الايصال</th>
